...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6130);
...
const package_namespaceObject = {"i8":"11.11.0"};
...
var React = _interopRequireWildcard(__webpack_require__(6130));
...
var _scrollHandler = __webpack_require__(1432);
var _react = __webpack_require__(6130);
...
var _react = _interopRequireDefault(__webpack_require__(6130));
...
const React=__webpack_require__(6130);const{grabMatchParams}=__webpack_require__(9755);const{StaticQueryContext}=__webpack_require__(7076);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9706);const{ServerLocation,Router}=__webpack_require__(7896);const{renderToString}=__webpack_require__(1305);const{parse}=__webpack_require__(698);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4836);var React=_interopRequireWildcard(__webpack_require__(6130));var _gatsby=__webpack_require__(7076);var _common=__webpack_require__(5428);var _getManifestPathname=_interopRequireDefault(__webpack_require__(292));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
;// CONCATENATED MODULE: ./src/@lekoarts/gatsby-theme-cara/gatsby-plugin-theme-ui/index.js
const gatsby_plugin_theme_ui_theme=(0,theme_ui_core_esm/* merge */.TS)(gatsby_plugin_theme_ui,{colors:{background:"#f9f9ff",text:"#181c25",primary:"#5A67D8",secondary:"#F6AD55",muted:"#f1f3ff",heading:"#181c25",modes:{dark:{background:"#141821",text:"#f9f9ff",primary:"#bdc2ff",secondary:"#ffddba",muted:"#2c303a",heading:"#ffffff"}}},fonts:{body:'"Inter", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", sans-serif',heading:'"Inter", system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", sans-serif',monospace:'Menlo, monospace'},styles:{root:{fontFamily:"body",lineHeight:"body",fontWeight:"body"}}});/* harmony default export */ const gatsby_theme_cara_gatsby_plugin_theme_ui = (gatsby_plugin_theme_ui_theme);
...
const Root=({children})=>{const themeUiConfig=configOptions();const{preset,prismPreset}=themeUiConfig;const theme=preset.default||preset;const themeWithPrism=(0,theme_ui_core_esm/* merge */.TS)(theme,{styles:{pre:prismPreset}});const fullTheme=(0,theme_ui_core_esm/* merge */.TS)(themeWithPrism,gatsby_theme_cara_gatsby_plugin_theme_ui);return/*#__PURE__*/index_js_default().createElement(ThemeProvider,{theme:fullTheme},/*#__PURE__*/index_js_default().createElement(lib/* MDXProvider */.Zo,{components:(0,theme_ui_mdx_esm/* useThemedStylesWithMdx */.dl)((0,lib/* useMDXComponents */.ah)(src_components))},children));};const WrapRootElement=({element})=>{return/*#__PURE__*/index_js_default().createElement(Root,null,element);};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(6464),e=__webpack_require__(6130),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/Users/tony/Gatsby-Pages-1/.cache/ssr-builtin-trackers/fs");
...
"use strict";
module.exports = require("/Users/tony/Gatsby-Pages-1/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/Users/tony/Gatsby-Pages-1/node_modules/react/index.js");
